			...
			<form method="post" enctype="multipart/form-data">
		         <table>
		             ...
		             <tr>
		                 ...
		                 <td><input type="text" id="username" name="username" value="${member.membername}"> </td>
		             </tr>
		              <tr>
		                 <th><label for="userphoto">현재 사진</label></th>
		                 <td> 
		                 	<img height="50" alt="현재 프로필 사진" src="<c:url value="/fileupload/member/${member.memberphoto}" />">
