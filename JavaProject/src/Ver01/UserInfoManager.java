...
//	            break;
	...
	public void showMyInfo(){
	      ...
	      LoginInfo info = new LoginInfo();
	      LoginInfoManager manager = new LoginInfoManager();
	      
	      while(true) {
	      System.out.println("1. 예매내역 조회");
	      System.out.println("2. 이벤트 조회");
	      System.out.println("3. 회원정보 조회");
	      System.out.println("4. ID/PW 변경");
	      System.out.println("5. 탈퇴");
	      System.out.println("6. 홈 메뉴로 돌아가기");
	      System.out.println("\n>>");
	    	 ...
	    	 select =Util.sc.nextInt();
	            ...
	            switch(select) {
		         ...
		         case 2:
		            ...
		            break;
		         case 3:
		        	info.showLoginInfo();		// ID, PW, 포인트 출력
		        								// 충전금액 출력
		         case 4: 
		        	try {
						manager.changeLoginInfo();	// ID/PW 변경
					} catch (IOException e) {
						e.printStackTrace();
					}	
		        	break;
