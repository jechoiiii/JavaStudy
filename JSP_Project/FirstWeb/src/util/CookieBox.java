...
public class CookieBox {
	...
	// 이름으로 쿠키의 저장 값을 반환 
	public String getValue(String name) throws IOException { // 상위클래스로 한번에 예외처리
		
		Cookie cookie =  cookieMap.get(name); // Map에 name의 키가 없는 경우 null 반환 
	...
	// 쿠키 객체를 생성해주는 메서드 : 객체를 생성하지 않고도 사용할 수 있는 메서드로 정의 : static 멤버로 정의 
	...
	// 이름, 값, 경로, 유지 시간을 가지고 Cookie 객체를 생성 
	...
	// 이름, 값, 경로, 유지 시간, 도메인을 가지고 Cookie 객체를 생성 
